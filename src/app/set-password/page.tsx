        ...
        return (
            <AuthLayout>
                <div className="w-full text-center">
                    <h1 className="text-2xl font-semibold text-gray-900 mb-2">Senha definida com sucesso!</h1>
    ...
    return (
        <AuthLayout>
            <div className="w-full text-center mb-8">
                <h1 className="text-2xl font-semibold text-gray-900 mb-2">Defina sua senha</h1>
                <p className="text-sm text-gray-500">
                    Crie uma senha segura para acessar sua conta AgroBravo.
                </p>
            </div>
